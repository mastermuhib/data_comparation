                            ...
                            <div class="row mb-5">
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{$data->medicine}}" name="medicine" required>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label>Keterangan Singkat</label>
                                        <textarea name="notes" class="form-control" placeholder="Obat Batuk">{{$data->notes}}</textarea>
                                    </div>
                                </div> 
                                <div class="col-md-12">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body text-center">
                                            @if($data->icon != null)
                                            <img id="profile_admin" src="{{env('BASE_IMG')}}{{$data->icon}}" alt="your image" style="max-width: 200px;max-height: 200px;" />
                                            @else
