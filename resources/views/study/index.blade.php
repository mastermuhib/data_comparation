                            ...
                            <div class="row mb-5">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="study_name" class="form-control form-control-lg" placeholder="Name" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <fieldset class="form-label-group mb-0">
                                            <textarea data-length="2000" class="form-control char-textarea active summernote" id="description" rows="3" placeholder="Deskripsi" name="description" style="color: rgb(78, 81, 84);"></textarea>
                                        </fieldset>
    ...
    <div class="col-lg-12 col-xxl-4">
        ...
        <div class="card card-custom card-stretch gutter-b">
            ...
            <div class="card-header align-items-center border-0 mt-2">
                <h5 class="text-dark font-weight-bold ml-3">List Mata Pelajaran</h5>
                <a class="btn btn-primary font-weight-bolder mr-3" id="tambah">Add Mata pelajaran</a>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
