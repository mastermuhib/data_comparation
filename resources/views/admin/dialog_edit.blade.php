                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" required data-validation-required-message="Role Wajib diisi" name="id_role" id="role">
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="select_cabang" name="branch_id" required>
