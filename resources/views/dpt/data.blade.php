	...
	<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 mt-3">
		...
		<div class="card card-custom gutter-b card-stretch">
			...
			<div class="card-body pt-4">
					...
					<div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left" data-original-title="Quick actions">
						...
						<div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="">
							...
							<ul class="navi navi-hover">
								...
								@if($is_edit == 1)
								<li class="navi-item">
									<a href="/user/siswa/{{base64_encode($d->id)}}" class="navi-link">
								...
								@endif
								<li class="navi-item">
									<a href="/medical-record/list/{{base64_encode($d->id)}}/1" class="navi-link">
										<span class="navi-text">
											<span class="label label-xl label-inline label-light-success"><i class="fas fa-clipboard-list text-success mr-2"></i> Medical Record</span>
										</span>
									</a>
								</li>
								@if($is_delete == 1)
				...
				<div class="d-flex align-items-end mb-7">
					...
					<div class="d-flex align-items-center">
						...
						<div class="flex-shrink-0 mr-4 mt-lg-0 mt-3">
                            ...
                            <div class="d-flex align-items-center">
                            	<div class="symbol symbol-60 symbol-circle symbol-light-warning flex-shrink-0">
                            		<span class="symbol-label font-size-h4 font-weight-bold">{{substr($d->student_name, 0, 1)}}</span>
                            	</div>
                            </div>
                            @endif
						</div>
						...
						<div class="d-flex flex-column">
							<a href="#" class="text-dark font-weight-bold text-hover-primary font-size-h4 mb-0">{{$d->student_name}}</a>
							<span class="text-muted font-weight-bold">nisn# {{$d->nisn}}</span>
						</div>
						<!--end::Title-->
					</div>
					<!--end::Title-->
				...
				<!--begin::Desc-->
				<p class="mb-7">
				<a href="#" class="text-primary pr-1">{{$d->scholl}} ({{$d->class}}) </a></p>
				<!--end::Desc-->
				<!--begin::Info-->
				<div class="mb-7">
				...
				<!--end::Info-->
                @if($d->status == 1)
				<a href="javascript:void(0)" class="btn aksi_status btn-block btn-sm btn-light-success font-weight-bolder text-uppercase py-4" id="{{$d->id}}" aksi="nonactive" tujuan="siswa" data="">active</a>
				@else
				<a href="javascript:void(0)" class="btn aksi_status btn-block btn-sm btn-light-danger font-weight-bolder text-uppercase py-4" id="{{$d->id}}" aksi="active" tujuan="siswa" data="">Tidak active</a>
				@endif
			</div>
			<!--end::Body-->
		</div>
