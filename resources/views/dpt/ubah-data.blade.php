    ...
    <div class="card p-6 col-md-12">
        <div class="card-header" id="faqHeading2">
            <div class="card-title font-size-h4 text-dark" data-toggle="collapse" data-target="#faq2" aria-expanded="false" aria-controls="faq2" role="button">
                <div class="card-label">Upload Perubahan Data<i class="fas fa-plus"></i></div>
                ...
                <form method="POST" class="form-horizontal p-3" id="form_add" enctype="multipart/form-data">@csrf
                    <div class="row" data-select2-id="4">
                        ...
                        <div class="col-md-2">
                            ...
                            <select class="select2 form-control" id="triwulan" name="triwulan" required>
                               
                                <option value="1">Triwulan I</option>
                                <option value="2" selected>Triwulan II</option>
                        ...
                        <div class="col-md-3 mt-3">
                            <div class="form-group">
                                <label>Lokasi Kolom NIK</label>
                                <input type="number" class="form-control" name="nik" required>
                            </div>
                        </div>
                        <div class="col-md-3 mt-3">
                            <div class="form-group">
                                <label>Lokasi Kolom Data Lama</label>
                                <input type="number" class="form-control" name="old" required>
                            </div>
                        </div>
                        <div class="col-md-3 mt-3">
                            <div class="form-group">
                                <label>Lokasi Kolom Data Baru</label>
                                <input type="number" class="form-control" name="new" required>
                            </div>
                        </div>
                        <div class="col-md-3 mt-5">
                            <div class="form-group">
                                <button type="submit" id="save_btn" class="btn btn-lg btn-block btn-primary float-right">Submit</button>
                                <button type="button" id="loading_btn" class="btn btn-lg btn-block btn-primary float-right" style="display: none;" disabled>Loading.....</button>
                            </div>
                        </div>
                    </div>
                </form>
