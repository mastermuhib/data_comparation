	...
	<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 mt-3">
		...
		<div class="card card-custom gutter-b card-stretch">
			...
			<div class="card-body pt-4">
				...
				<!--end::Info-->
                @if($d->status == 1)
				<a href="javascript:void(0)" class="btn aksi_status btn-block btn-sm btn-light-success font-weight-bolder text-uppercase py-4" id="{{$d->id}}" aksi="nonactive" tujuan="parent" data="">active</a>
				@else
				<a href="javascript:void(0)" class="btn aksi_status btn-block btn-sm btn-light-danger font-weight-bolder text-uppercase py-4" id="{{$d->id}}" aksi="active" tujuan="parent" data="">Tidak active</a>
				@endif
			</div>
			<!--end::Body-->
		</div>
