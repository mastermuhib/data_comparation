                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control country" required data-validation-required-message="Country Wajib diisi" name="country" id="country">
                                ...
                                <div class="col-md-12" id="provinsi">
                                    <div class="form-group">
                                        <label class="control-label">Province</label>
                                        <select class="select2 form-control province" required data-validation-required-message="Province Wajib diisi" name="province">
    ...
    <div class="col-lg-12 col-xxl-4">
        ...
        <div class="card card-custom card-stretch gutter-b">
            ...
            <div class="card-header align-items-center border-0 mt-2">
                <h5 class="text-dark font-weight-bold ml-3">List City</h5>
                <a class="btn btn-primary font-weight-bolder mr-3" id="tambah">Add City</a>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
